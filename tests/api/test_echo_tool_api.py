"""Auto-generated API tests for: echo_tool
    ...
    def test_parameter_validation_via_api(self, client, valid_jwt_headers, test_session):
        ...
        request_data = {
            ...
            "payload": {
                "tool_name": "echo_tool",
                "parameters": {
                    "message": 12345,  # Wrong type - should be string
                }
            }
        }
...
@pytest.mark.api
class TestAPIEchotoolToolRegistry:
    """Test tool registry endpoints for echo_tool."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that echo_tool appears in /tools/ endpoint."""
    ...
    def test_get_tool_definition(self, client):
        ...
        response = client.get("/tools/echo_tool")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "echo_tool"
