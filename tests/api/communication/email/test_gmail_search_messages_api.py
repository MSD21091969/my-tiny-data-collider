"""Auto-generated API tests for: gmail_search_messages
...
@pytest.mark.api
class TestAPIGmailsearchmessages:
    """API tests for gmail_search_messages through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIGmailsearchmessagesToolRegistry:
    """Test tool registry endpoints for gmail_search_messages."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that gmail_search_messages appears in /tools/ endpoint."""
    ...
    def test_get_tool_definition(self, client):
        ...
        response = client.get("/tools/gmail_search_messages")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "gmail_search_messages"
