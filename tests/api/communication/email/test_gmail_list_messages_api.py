"""Auto-generated API tests for: gmail_list_messages
...
@pytest.mark.api
class TestAPIGmaillistmessages:
    """API tests for gmail_list_messages through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIGmaillistmessagesToolRegistry:
    """Test tool registry endpoints for gmail_list_messages."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that gmail_list_messages appears in /tools/ endpoint."""
    ...
    def test_get_tool_definition(self, client):
        ...
        response = client.get("/tools/gmail_list_messages")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "gmail_list_messages"
