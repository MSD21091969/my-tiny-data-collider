"""Auto-generated API tests for: gmail_get_message
...
@pytest.mark.api
class TestAPIGmailgetmessage:
    """API tests for gmail_get_message through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIGmailgetmessageToolRegistry:
    """Test tool registry endpoints for gmail_get_message."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that gmail_get_message appears in /tools/ endpoint."""
    ...
    def test_get_tool_definition(self, client):
        ...
        response = client.get("/tools/gmail_get_message")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "gmail_get_message"
