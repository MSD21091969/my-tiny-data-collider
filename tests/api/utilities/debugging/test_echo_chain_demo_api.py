"""Auto-generated API tests for: echo_chain_demo
...
@pytest.mark.api
class TestAPIEchochaindemo:
    """API tests for echo_chain_demo through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIEchochaindemoToolRegistry:
    """Test tool registry endpoints for echo_chain_demo."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that echo_chain_demo appears in /tools/ endpoint."""
        ...
        assert "echo_chain_demo" in tool_names
    
    def test_get_tool_definition(self, client):
        """Test GET /tools/{tool_name} endpoint."""
        response = client.get("/tools/echo_chain_demo")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "echo_chain_demo"
