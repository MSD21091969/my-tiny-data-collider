"""Auto-generated API tests for: gmail_to_drive_pipeline
...
@pytest.mark.api
class TestAPIGmailtodrivepipeline:
    """API tests for gmail_to_drive_pipeline through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIGmailtodrivepipelineToolRegistry:
    """Test tool registry endpoints for gmail_to_drive_pipeline."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that gmail_to_drive_pipeline appears in /tools/ endpoint."""
        ...
        assert "gmail_to_drive_pipeline" in tool_names
    
    def test_get_tool_definition(self, client):
        """Test GET /tools/{tool_name} endpoint."""
        response = client.get("/tools/gmail_to_drive_pipeline")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "gmail_to_drive_pipeline"
