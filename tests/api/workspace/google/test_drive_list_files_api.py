"""Auto-generated API tests for: drive_list_files
...
@pytest.mark.api
class TestAPIDrivelistfiles:
    """API tests for drive_list_files through HTTP endpoints."""
...
@pytest.mark.api
class TestAPIDrivelistfilesToolRegistry:
    """Test tool registry endpoints for drive_list_files."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that drive_list_files appears in /tools/ endpoint."""
    ...
    def test_get_tool_definition(self, client):
        ...
        response = client.get("/tools/drive_list_files")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "drive_list_files"
