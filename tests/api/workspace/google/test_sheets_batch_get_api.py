"""Auto-generated API tests for: sheets_batch_get
...
@pytest.mark.api
class TestAPISheetsbatchget:
    """API tests for sheets_batch_get through HTTP endpoints."""
...
@pytest.mark.api
class TestAPISheetsbatchgetToolRegistry:
    """Test tool registry endpoints for sheets_batch_get."""
    
    def test_tool_listed_in_registry(self, client):
        """Test that sheets_batch_get appears in /tools/ endpoint."""
        ...
        assert "sheets_batch_get" in tool_names
    
    def test_get_tool_definition(self, client):
        """Test GET /tools/{tool_name} endpoint."""
        response = client.get("/tools/sheets_batch_get")
        
        assert response.status_code == 200
        tool_def = response.json()
        assert tool_def["name"] == "sheets_batch_get"
