"""Auto-generated integration tests for: multi_echo_pipeline
...
@pytest.mark.asyncio
class TestIntegrationMultiechopipeline:
    """Integration tests for multi_echo_pipeline through service layer."""
...
@pytest.mark.asyncio
class TestIntegrationMultiechopipelinePolicies:
    """Test policy enforcement for multi_echo_pipeline at service layer."""
