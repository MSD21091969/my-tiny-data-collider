"""Auto-generated integration tests for: gmail_list_messages
...
@pytest.mark.asyncio
class TestIntegrationGmaillistmessages:
    """Integration tests for gmail_list_messages through service layer."""
    ...
    async def test_scenario_unread_messages(self, service, test_session):
        ...
        assert response.payload.result["result_size_estimate"] == 2


@pytest.mark.asyncio
class TestIntegrationGmaillistmessagesPolicies:
    """Test policy enforcement for gmail_list_messages at service layer."""
