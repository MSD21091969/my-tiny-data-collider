"""Auto-generated integration tests for: echo_tool
...
@pytest.mark.asyncio
class TestIntegrationEchotool:
    """Integration tests for echo_tool through service layer."""
...
@pytest.mark.asyncio
class TestIntegrationEchotoolPolicies:
    """Test policy enforcement for echo_tool at service layer."""
