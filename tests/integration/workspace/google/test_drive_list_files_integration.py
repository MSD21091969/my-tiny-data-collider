"""Auto-generated integration tests for: drive_list_files
...
@pytest.mark.asyncio
class TestIntegrationDrivelistfiles:
    """Integration tests for drive_list_files through service layer."""
...
@pytest.mark.asyncio
class TestIntegrationDrivelistfilesPolicies:
    """Test policy enforcement for drive_list_files at service layer."""
