"""
Access Control List (ACL) models for casefile permissions.

Defines permission models following Pydantic v2 best practices
for managing user access to casefiles.
"""
...
# Request/Response models for ACL operations
