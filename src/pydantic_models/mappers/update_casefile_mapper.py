"""Auto-generated mapper for update_casefile operation."""
...
class UpdateCasefileMapper(BaseMapper[AddSessionToCasefilePayload, CasefileModel]):
    """Transforms update_casefile payloads to/from domain models."""
