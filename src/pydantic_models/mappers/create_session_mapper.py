"""Auto-generated mapper for create_session operation."""
...
class CreateSessionMapper(BaseMapper[ChatSessionClosedPayload, ToolSessionModel]):
    """Transforms create_session payloads to/from domain models."""
