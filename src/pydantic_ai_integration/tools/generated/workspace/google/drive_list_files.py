...
async def drive_list_files(
    ...
    from src.pydantic_ai_integration.google_workspace import DriveClient
    from src.pydantic_ai_integration.google_workspace import DriveListFilesRequest
    
    # Initialize client
    client = DriveClient(user_id=ctx.user_id)
    
    # Build request
    request = DriveListFilesRequest(
        page_size=page_size,        query=query,        order_by=order_by,        page_token=page_token    )
    response = await client.list_files(request=request)
