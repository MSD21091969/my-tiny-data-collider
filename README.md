...
generate-tools              # Generate tools from YAML
pytest tests/unit/ -v       # Run tests
```

**Documentation:**
- **[INSTALL.md](INSTALL.md)** - Installation, requirements, environment setup, tool generation
- **[CONTRIBUTING.md](CONTRIBUTING.md)** - Developer guidelines, coding standards, workflows
